 ...
 */
public class DekkerFinal implements Runnable {
	...
	protected void entradaSeccionCritica(int numHebra) {
		...
		while(_enSeccionCritica[otraHebra].valor) {
			if (_turno == otraHebra) {
				// El turno es de la otra hebra. La dejamos
				// pasar, anulando nuestra intención de entrar
				// como haríamos en el cuarto intento.
				...
				// Queremos entrar, y es nuestro turno. O bien
				// la otra hebra está dentro, o bien está intentando
				// entrar y caso nos cruzamos (livelock). Esperamos
				// hasta que termine.
				;
			}
		} // while
	...
	public static void main(String[] args) throws InterruptedException {
		...
		DekkerFinal racer = new DekkerFinal();
		Thread t1, t2;

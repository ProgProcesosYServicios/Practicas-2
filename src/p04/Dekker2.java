 ...
 * 
 * Para evitar la condición de carrera, se hace uso del segundo
 * intento del algoritmo de Dekker.
 * 
 * @author Pedro Pablo Gómez Martín
 */
public class Dekker2 implements Runnable {
	...
	protected void entradaSeccionCritica(int numHebra) {
		...
		/*
		   ...
		   _enSeccionCritica[otraHebra] cambia, tendremos condición
		   de carrera: dos hebras entraremos en la sección crítica.
		   
		   En multiprocesador seguramente sufrirás condición de carrera
		   directamente. En monoprocesador es mucho menos probable, pero
		   puedes forzar en este instante el cambio de contesto. Pero
		   hazlo únicamente si eres una de las dos hebras. Si se hace
		   en las dos, los dos yield se compensan y te libras :-)
		if(numHebra == 0)
			Thread.yield();
		 */

		// ¡Está libre! (en realidad no necesariamente...)
